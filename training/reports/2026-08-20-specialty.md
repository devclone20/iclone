# 📚 Treino — Especialidade (Ter/Qui) — 2026-08-20

_Sessão: Scheduled · 05:23 UTC · 2/2 agentes treinados._

## Resumo

| Agente | Módulos de hoje | Drills | Sessões totais |
| --- | --- | --- | --- |
| **doctor-agent** | The review craft — reading a paper the IST way · IST academic standards — writing at Técnico level | 3/3 ✅ | 12 |
| **forense-ai** | Digital evidence — preserve first, analyse second · Root-cause investigation — to the origin, always | 3/3 ✅ | 12 |
