# 📚 Treino — Especialidade (Ter/Qui) — 2026-08-25

_Sessão: Scheduled · 05:25 UTC · 2/2 agentes treinados._

## Resumo

| Agente | Módulos de hoje | Drills | Sessões totais |
| --- | --- | --- | --- |
| **doctor-agent** | The university's scientific repository — Doctor's home ground · The review craft — reading a paper the IST way | 2/2 ✅ | 15 |
| **forense-ai** | Investigating on the open web — any web, verified · Digital evidence — preserve first, analyse second | 3/3 ✅ | 15 |
