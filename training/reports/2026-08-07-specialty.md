# 📚 Treino — Especialidade (Ter/Qui) — 2026-08-07

_Sessão: Estreia da especialidade Ter/Qui · 07:20 UTC · 2/2 agentes treinados._

## Resumo

| Agente | Módulos de hoje | Drills | Sessões totais |
| --- | --- | --- | --- |
| **doctor-agent** | IST academic standards — writing at Técnico level · The university's scientific repository — Doctor's home ground | 3/3 ✅ | 2 |
| **forense-ai** | Root-cause investigation — to the origin, always · Investigating on the open web — any web, verified | 4/4 ✅ | 2 |
...
- Sonda web: Certificate Transparency — crt.sh → ✅ HTTP 200 — “crt.sh | Certificate Search” (<https://crt.sh>)
