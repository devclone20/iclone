...
class HermesTraining:
    ...
    # -------------------------------------------------------------------------
    # HERMES SLASH COMMANDS (interactive CLI + messaging gateway)
    # -------------------------------------------------------------------------
    HERMES_SLASH = {
        "session_management": {
            ...
            "/compress": "Manual context compression [here [N] | focus topic]",
            "/rollback [number]": "List or restore filesystem checkpoints",
            "/snapshot create|restore <id>|prune": "State snapshots (alias: /snap)",
            "/stop": "Kill background processes",
            "/queue <prompt>": "Queue prompt for next turn (alias: /q)",
            "/steer <prompt>": "Inject note mid-run after next tool call",
            "/goal <text>": "Set standing goal — subcommands: status, pause, resume, clear",
            "/subgoal <text>": "Append criterion to active goal",
            "/resume [name]": "Resume named session",
            "/sessions": "Browse sessions (alias: /switch)",
            "/background <prompt>": "Run in separate session (aliases: /bg, /btw)",
            "/branch [name]": "Branch current session (alias: /fork)",
            "/agents": "Show active agents and tasks (alias: /tasks)",
        },
        ...
        "tools_skills": {
            ...
            "/kanban <action>": "Drive collaboration board",
            "/reload-mcp": "Reload MCP servers",
            "/reload-skills": "Re-scan skills directory",
            "/reload": "Reload .env variables",
            "/<skill-name>": "Invoke installed skill on-demand",
            "/plan": "Open plan mode (saves to .hermes/plans/)",
        },
        ...
        "info": {
            ...
            "/platforms": "Gateway/messaging status (alias: /gateway)",
            "/debug": "Upload debug report",
            "/quit": "Exit CLI (alias: /exit)",
        },

        "gateway_only": {
            "/start": "Platform protocol handshake",
            "/sethome": "Mark chat as platform home",
            "/topic [off|help|session-id]": "Multi-session mode (Telegram DM only)",
